...
export const DISTRICT_CONFIGS: Record<District, DistrictConfig> = {
  cross: {
    ...
    dogFrequency: 0.3,
    ibisFrequency: 0.2,
    dominantBlocks: ['stripclub', 'bar', 'hostel', 'alley'],
    clutterTypes: ['neon', 'bottles', 'trash', 'posters'],
    signage: ['XXX', 'GIRLS', 'CLUB', 'BAR', '24HR', 'HOSTEL'],
  },
  oxford: {
    neonIntensity: 0.8,
    warmth: 0.5,
    ...
    dogFrequency: 0.2,
    ibisFrequency: 0.3,
    dominantBlocks: ['bar', 'kebab', 'club', 'shop'],
    clutterTypes: ['bottles', 'kebabvan', 'posters', 'crates'],
    signage: ['PUB', 'KEBAB', 'DANCE', 'CLUB', 'BAR'],
  },
  cbd: {
    neonIntensity: 0.3,
    warmth: 0.2,
    ...
    dogFrequency: 0.1,
    ibisFrequency: 0.4,
    dominantBlocks: ['services', 'shelter', 'pawn', 'office'],
    clutterTypes: ['newsrack', 'phonebooth', 'busstop', 'bins'],
    signage: ['SERVICES', 'SHELTER', 'CASH', 'PAWN', 'BOTTLEO'],
  },
  chinatown: {
    neonIntensity: 0.6,
    warmth: 0.9,
    ...
    clutterTypes: ['crates', 'bins', 'steam', 'lanterns'],
    signage: ['食', 'BBQ', 'NOODLE', 'DIM SUM', 'RICE'],
  },
  central: {
    neonIntensity: 0.2,
    warmth: 0.3,
    ...
    dogFrequency: 0.4,
    ibisFrequency: 0.6,
    dominantBlocks: ['station', 'alley', 'bins', 'generic'],
    clutterTypes: ['trash', 'bottles', 'newsrack', 'phonebooth'],
    signage: ['TRAINS', 'EXIT', 'TAB', 'NEWS'],
  },
  redfern: {
    neonIntensity: 0.1,
    warmth: 0.2,
    ...
    dogFrequency: 0.8,
    ibisFrequency: 0.9,
    dominantBlocks: ['bins', 'pawn', 'tab', 'boarded', 'alley'],
    clutterTypes: ['trash', 'bottles', 'crates', 'bins', 'puddles'],
    signage: ['TAB', 'PAWN', 'CASH', 'BOTTLEO'],
  },
};
